...
document.querySelector("#skills").appendChild(image);

/*
 * Your skills data.
 */
const skills = [
	{ text: "HTMl", size: 27, color: "#F07200" },
	{ text: "Css", size: 11, color: "yellow" },
    { text: "JavaScript", size: 20, color: "pink" },
	{ text: "Vue.js", size: 18, color: "chartreuse" },
    { text: "Flutter", size: 25, color: "pink" },
    { text: "Angular", size: 15, color: "cyan" },
    { text: "Laravl", size: 15, color: "pink" },
    { text: "MongoDB", size: 15, color: "green" },
    { text: "Mysql", size: 15, color: "pink" },
    { text: "Nodejs", size: 18, color: "pink" },
    { text: "Cypress", size: 20, color: "pink" },
	{ text: "Illustration", size: 17, color: "orange" },
	{ text: "UI & UX", size: 20, color: "red" },
...
const colors = ["#FFC900", "#29A4E8", "#FF4100", "#1CE840", "#DD0DFF", "#F07200"];
